  ...
  return (
    <div className="container">
      <div className="row mb-5">
        ...
        <div
          className="col-md-8 project-details"
          data-aos="fade-up"
          data-aos-duration="500"
        >
          ...
          <div className="project-link">
            ...
            <a href={project?.frontendGit} target="_blank" rel="noreferrer">
              <i className="fa fa-github"></i> Client Side
            </a>
            {project?.backendGit && (
              <a href={project?.backendGit} target="_blank" rel="noreferrer">
